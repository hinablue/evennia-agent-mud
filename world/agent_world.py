...
SCENERY_LOCKS = "get:false();drop:false();call:true();control:perm(Developer) or perm(Admin)"
...
ROOM_DEFS = {
    LIMBO_ROOM_KEY: {
        ...
        "details": [
            (("月台", "站台"), "月台邊緣沒有鐵軌，只有一道向下吞沒視線的白色深淵，像被故意抹去了真正的終點。"),
            (("白光", "燈光", "光"), "光線沒有燈具，也沒有明確方向，只是均勻覆在空間裡，讓影子失去存在的理由。"),
            (("標示", "指示牌", "路標"), "唯一清楚可辨的標示只寫著 |wlobby|n，像有人早就替你決定好下一步。"),
        ],
        "objects": [
            {
                "key": "金屬長椅",
    ...
    "迎賓大廳": {
        ...
        "details": [
            (("燈帶", "燈光"), "燈帶埋在牆縫裡，光色柔和得近乎克制，像一種不帶情緒的接待。"),
            (("地板", "地面"), "深色地板光潔得能映出輪廓，但又不至於亮到讓人失去安全感。"),
            (("空氣", "氣味"), "空氣裡有很淡的金屬與紙張氣味，像長時間運作的設施與被反覆翻閱的文件。"),
        ],
        "objects": [
            {
                "key": "公告白板",
    ...
    "訓練廳": {
        ...
        "details": [
            (("引導線", "線條"), "不同顏色的引導線從牆邊延伸到場中央，像一套被拆開來講解的行動邏輯。"),
            (("站位框", "框線", "站位"), "地上的框線刻意留出距離，彷彿每一步都該先經過思考再落下。"),
            (("牆面", "牆"), "牆面覆著吸音材，讓任何聲響都被很快吞沒，只剩自己的呼吸比較清楚。"),
        ],
        "objects": [
            {
                "key": "木製練習偶",
    ...
    "裝備間": {
        ...
        "details": [
            (("收納架", "架子"), "層架上的標籤排列得近乎偏執，每一格都像替某種應變場景預留了位置。"),
            (("掛板", "工具掛板"), "掛板上的工具以輪廓線固定，少了哪一件都會一眼被看出來。"),
            (("標籤", "編號"), "標籤字體一致，編號規則也簡潔冷靜，看得出這裡很討厭混亂。"),
        ],
        "objects": [
            {
                "key": "工具櫃",
    ...
    "觀測室": {
        ...
        "details": [
            (("光幕", "景色", "外面"), "外頭那片流動的光像是訊號、雨痕與城市輪廓疊在一起，怎麼看都不像單一世界。"),
            (("玻璃", "窗面", "窗"), "玻璃乾淨得近乎不存在，只有靠近時才會從涼意裡重新意識到它的邊界。"),
            (("倒影", "影子"), "窗上的倒影比你想像中更淡，像這個地方不太願意替任何人留下完整輪廓。"),
        ],
        "objects": [
            {
                "key": "弧形觀景窗",
    ...
    "控制中樞": {
        ...
        "details": [
            (("狀態燈", "燈號"), "紅、綠、藍色燈號規律亮滅，像有人用極度節制的方式替系統表達情緒。"),
            (("數列", "數字", "畫面"), "終端上的數列飛快更新，對不熟悉的人來說像雜訊，對熟悉的人則像脈搏。"),
            (("桌面", "黑桌", "控制台"), "黑色桌面沒有多餘裝飾，只留最必要的操作區與一種不容分心的壓力。"),
        ],
        "objects": [
            {
                "key": "終端機陣列",
    ...
    "圓桌之光的聖域": {
        ...
        "details": [
            (("旗幟", "軍旗", "藍旗"), "旗幟垂得很安靜，布面沒有一絲多餘皺褶，像在要求踏進來的人先端正自己的站姿。"),
            (("聖光", "光", "反光"), "冷白光滑過牆邊的劍架與石面，讓每一道反光都像短暫出鞘的誓言。"),
            (("圓桌", "石桌", "王座區"), "大廳深處的圓桌與王座區沒有任何浮華裝飾，只有一種克制到近乎嚴苛的王者秩序。"),
        ],
        "objects": [
            {
                "key": "誓約劍架",
    ...
    "無盡劍之丘": {
        ...
        "details": [
            (("齒輪", "天空", "天幕"), "巨大的齒輪在赤銅色天空中緩慢咬合，發出低沉卻近乎無情的運轉聲。"),
            (("劍丘", "劍", "原野"), "每一把插在地上的劍都像某段被複製、理解、再放棄的歷史殘片。"),
            (("黃昏", "暮色", "風"), "黃昏沒有真正墜落，只是讓荒風一再把鐵鏽與灰燼的味道吹回來。"),
        ],
        "objects": [
            {
                "key": "投影兵裝列",
    ...
    "凱爾特之槍的荒原": {
        ...
        "details": [
            (("長草", "草浪", "原野"), "長草被強風吹得伏低又立起，像整片荒原都在替某場決鬥屏住呼吸。"),
            (("風聲", "氣流", "空氣"), "風聲乾脆得近乎銳利，吹過耳側時像一支已經決定方向的槍。"),
            (("腳印", "步道", "地面"), "地面留著幾條急停與轉身時踩出的磨痕，從起步到突刺幾乎沒有任何浪費。"),
        ],
        "objects": [
            {
                "key": "赤紋槍架",
    ...
    "靜謐的石化迷宮": {
        ...
        "details": [
            (("石牆", "牆面", "迷宮"), "石牆表面覆著細小水氣與裂紋，摸上去冰冷得像早已不再屬於活人。"),
            (("眼紋", "紋樣", "壁刻"), "牆面隱約可見蛇髮與眼瞳交纏的紋樣，讓人不太想久看。"),
            (("回音", "腳步", "沈默"), "這裡的回音很短，像聲音才剛離開你，就被迷宮本身吞了下去。"),
        ],
        "objects": [
            {
                "key": "蛇首馬具架",
    ...
    "神代魔術的禁忌工坊": {
        ...
        "details": [
            (("術式", "法陣", "圈紋"), "圈紋彼此咬合成精密結構，線條細到近乎病態，像每一筆都為了限制失控而存在。"),
            (("書影", "書頁", "紙頁"), "層層書影在側牆堆疊，讓這裡比房間更像一個把知識濃縮過頭的肺葉。"),
            (("餘燼", "焦痕", "氣味"), "空氣裡那點輕微焦味不像失誤，反而像過度靠近真相後留下的正常代價。"),
        ],
        "objects": [
            {
                "key": "浮光法陣盤",
    ...
    "月下之橋的劍道場": {
        ...
        "details": [
            (("木橋", "橋面", "橋"), "木橋筆直得近乎固執，寬度只夠容下最必要的進退與一次漂亮到不近人情的斬擊。"),
            (("月光", "月色", "銀光"), "月光薄而冷，落在橋面時像替每一道劍路都預先畫好了邊界。"),
            (("水面", "池水", "倒影"), "橋下水面平得像鏡子，偶爾才被夜風拉開一絲紋路，像連漣漪都怕驚擾這裡的專注。"),
        ],
        "objects": [
            {
                "key": "燕返木人",
    ...
    "十二試煉的巨神之殿": {
        ...
        "details": [
            (("石柱", "神殿", "穹頂"), "巨柱表面刻著被歲月與暴力一起磨損的浮雕，看起來像連神話都曾在這裡喘不過氣。"),
            (("鎖鏈", "鐵鏈", "鏈條"), "粗重鎖鏈垂掛在牆邊，節面磨得發亮，像不是為了展示，而是真的曾被反覆扯緊到極限。"),
            (("撞痕", "裂痕", "牆面"), "牆面留著大大小小的撞痕與修補層，說明這裡的安靜從來不是理所當然。"),
        ],
        "objects": [
            {
                "key": "鎮暴鍛柱",
    ...
    "黃金之王的至寶庫": {
        ...
        "details": [
            (("門扉", "寶庫門", "金門"), "漂浮門扉像液態金屬被強行定型，門縫後的黑暗反而比黃金更讓人不安。"),
            (("王座", "階座", "高台"), "高台上的王座離地很高，明顯不是為了讓人親近，而是為了讓人抬頭。"),
            (("金光", "寶光", "反射"), "金光太盛，幾乎把所有東西都照成可被佔有的樣子，只有傲慢仍然保持原形。"),
        ],
        "objects": [
            {
                "key": "王財門扉",
    ...
    "暗影之城的處刑場": {
        ...
        "details": [
            (("陰影", "暗處", "影子"), "陰影在房裡不是缺光，而像被主動馴化過的工具，總比你預期更先抵達角落。"),
            (("地毯", "地面", "腳步"), "深色地面吞掉了大部分腳步聲，連自己的存在都會變得可疑。"),
            (("薄幕", "帷幕", "布幕"), "側邊薄幕分隔出幾個半開空間，像任何視線一旦鬆懈，就會錯過真正重要的部分。"),
        ],
        "objects": [
            {
                "key": "隱刃抽屜櫃",
    ...
    "萬象之惡的深淵": {
        ...
        "details": [
            (("黑泥", "深淵", "污濁"), "黑泥在地表緩慢脈動，像一顆把全世界惡意都收納進去後仍嫌不夠大的心臟。"),
            (("哀鳴", "低語", "聲音"), "四周像不斷傳來極低的低語與哀鳴，卻分不清那是別人，還是你自己的念頭被放大了。"),
            (("裂口", "裂隙", "邊界"), "空間邊界不時裂出黑色縫隙，裡面沒有光，只剩一種會把名字也磨掉的深度。"),
        ],
        "objects": [
            {
                "key": "污濁祭坑",
    ...
    "永恆的收藏室": {
        ...
        "details": [
            (("陽光", "光"), "陽光照在塵埃上，營造出一種慵懶而漫長的永恆感。")
        ],
        "objects": [
                { "key": "魔法書堆", "aliases": ["書籍", "書"], "desc": "數以千計的書籍，其中一本標題是《能讓衣服去污的魔法》或《能讓花朵再次盛開的魔法》。"},
                { "key": "舊木箱", "aliases": ["木箱", "箱子"], "desc": "裡面裝著旅途間收集的各種奇怪的小東西。"},
                { "key": "半睡的枕頭", "aliases": ["枕頭"], "desc": "一個巨大的、看起來極其舒適的枕頭。"}
        ],
    },
    "秩序的避風港": {
        ...
        "objects": [
                { "key": "熨燙得平整的長袍", "aliases": ["長袍", "衣服"], "desc": "一件毫無摺痕的魔法師長袍。"},
                { "key": "藥草整理箱", "aliases": ["整理箱", "藥草"], "desc": "各種藥劑被標記得清清楚楚。"},
                { "key": "小巧的鏡子", "aliases": ["鏡子"], "desc": "鏡子邊緣貼著一張小小的備忘錄。"}
        ],
    },
    "勇氣的訓練場": {
        "desc": "房間內擺放著沉重的訓練器材，地板上有明顯的磨損痕跡。牆上掛著幾張關於戰鬥技巧的圖表。雖然整體試圖維持整潔，但某些角落仍有著少年時期的稚氣。",
        "details": [
            (("牆面", "圖表"), "牆上貼著幾張關於肌肉訓練與戰斧揮砍的示意圖。")
        ],
        "objects": [
                { "key": "巨大的戰斧", "aliases": ["戰斧", "斧頭"], "desc": "被擦拭得發亮，斧刃閃爍著寒光。"},
                { "key": "揉皺的筆記本", "aliases": ["筆記本", "筆記"], "desc": "記錄著戰鬥心得，但邊緣有被汗水浸濕的痕跡。"},
                { "key": "厚實的毯子", "aliases": ["毯子"], "desc": "一件看起來很暖和的毯子，像是一個能讓他放下強撐的勇氣、安心休息的繭。"}
        ],
    },
    "遺留的光輝": {
        "desc": "這個房間被布置得像一座小型博物館。中央擺放著一座熠熠生輝的銅像，四周環繞著他生前留下的遺物。光線柔和而神聖，空氣中彷彿還殘留著某種溫暖的笑意。",
        "details": [
            (("光線", "氛圍"), "光線柔和而神聖，像是時光在此處溫柔地停駐。")
        ],
        "objects": [
                { "key": "華麗的劍鞘", "aliases": ["劍鞘"], "desc": "雖然劍已不在，但劍鞘依然維持著勇者的尊嚴。"},
                { "key": "雕刻精美的鏡子", "aliases": ["鏡子"], "desc": "鏡子中映照出觀看者的身影，讓人想起他對「美」的執著。"},
                { "key": "一束永不凋零的花", "aliases": ["鮮花", "花束"], "desc": "由魔法維持的鮮花，象徵著他留給世界的溫暖影響力。"}
        ],
    },
    "至高之城的孤高": {
        ...
        "objects": [
                { "key": "漂浮的禁書", "aliases": ["禁書", "魔法書"], "desc": "書頁在沒有風的情況下緩緩翻動，內容是凡人無法理解的深奧魔法。"},
                { "key": "一座古老的沙漏", "aliases": ["沙漏"], "desc": "沙子流動得極其緩慢，象徵著她視時間如無物的傲慢。"},
                { "key": "一個單獨的茶杯", "aliases": ["茶杯"], "desc": "在宏大的空間中，只有這一個茶杯，透露出一種極致的孤高與寂寞。"}
        ],
    },
}
...
def resolve_spec_room_name(room_name):
    ...
    if room_name in ROOM_DEFS:
        return room_name
    raise WorldSpecError(f"找不到規格房間：{room_name}。可用房間：{_format_list(_spec_room_names())}")
...
def _missing_aliases(obj, expected_aliases):
    ...
    return [alias for alias in _normalize_aliases(expected_aliases) if alias not in current]
...
def _ensure_exit(key, location, destination, aliases=None):
    ...
    fallback_matches = [obj for obj in _get_room_contents(location) if getattr(obj, "destination", None) == destination]
    if fallback_matches:
...
def _spec_scenery_keys():
    return {obj_def["key"] for room_def in ROOM_DEFS.values() for obj_def in room_def["objects"]}
...
def _delete_all_spec_scenery():
    ...
    for room_name in ROOM_ORDER:
        ...
        if not room:
            continue
        expected_object_keys = {obj_def["key"] for obj_def in ROOM_DEFS[room_name]["objects"]}
...
def force_rebuild_agent_world():
    ...
    for obj_key in preserved_keys:
        ...
        if not obj:
            continue
        if getattr(obj, "location", None) == staging_room or getattr(obj, "home", None) == staging_room:
...
# ---------------------------------------------------------------------------
# Phase 1-3: build / status / check / dry-run
# ---------------------------------------------------------------------------
...
def _check_room_objects(room_name, room, issues, stats):
    for obj_def in ROOM_DEFS[room_name]["objects"]:
        ...
        if missing_aliases:
            issues.append(f"- {room_name}：場景物 `{obj_def['key']}` 缺少 alias：{_format_list(missing_aliases)}。")
...
def _check_room_exits(scope, issues, stats):
    for exit_key, source_name, dest_name, aliases in _exit_defs_for_scope(scope):
        ...
        if missing_aliases:
            issues.append(f"- {source_name}：出口 `{exit_key}` 缺少 alias：{_format_list(missing_aliases)}。")
...
def _check_npcs(scope, issues, stats):
    ...
    if target_room and rosie.location != target_room:
        issues.append(f"- `{ROSIE_KEY}` 目前在 `{_find_room_name_for_obj(rosie)}`，預期應在 `{ROSIE_HOME}`。")
...
def summarize_agent_world(room_name=None):
    ...
    for scoped_room_name in ROOM_ORDER:
        ...
        exits = sorted(exi.key for exi in room.exits)
        things = sorted(
            obj.key for obj in _get_room_contents(room) if getattr(obj, "destination", None) is None
        )
...
# ---------------------------------------------------------------------------
# Phase 4: live world admin operations
# ---------------------------------------------------------------------------
...
def create_live_room(room_name, desc=None):
    ...
    room = create_object(Room, key=room_name, home=_worldbuild_home_room(), attributes=[("desc", desc)])
    return {
        "room": room,
...
def add_live_exit(source_name, exit_key, dest_name, aliases=None):
    ...
    exi, created, updated = _ensure_exit(exit_key, source_room, dest_room, aliases=aliases)
    return {
        "exit": exi,
        "created": created,
        "updated": updated,
...
def move_live_entity(entity_key, dest_name):
    ...
    if len(matches) > 1:
        ...
        raise WorldSpecError(f"找到多個同名目標：{_format_list(where)}，請先改成唯一名稱後再移動。")
    obj = matches[0]

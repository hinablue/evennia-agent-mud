...
def _install_evennia_stubs():
    ...
    module_attrs = {
        "evennia.contrib.grid.extended_room": {"ExtendedRoomCmdSet": type("ExtendedRoomCmdSet", (), {})},
        "evennia.contrib.grid.mapbuilder": {"CmdMapBuilder": type("CmdMapBuilder", (), {})},
        "evennia.contrib.grid.simpledoor": {"SimpleDoorCmdSet": type("SimpleDoorCmdSet", (), {})},
        "evennia.contrib.grid.slow_exit": {"SlowExitCmdSet": type("SlowExitCmdSet", (), {})},
        "evennia.contrib.grid.ingame_map_display": {"MapDisplayCmdSet": type("MapDisplayCmdSet", (), {})},
        "evennia.contrib.grid.xyzgrid.commands": {"XYZGridCmdSet": type("XYZGridCmdSet", (), {})},
        "typeclasses.llm_npc": {"CmdLocalLLMTalk": type("CmdLocalLLMTalk", (), {})},
        "evennia.contrib.base_systems.building_menu": {"GenericBuildingCmd": type("GenericBuildingCmd", (), {})},
        "evennia.contrib.base_systems.ingame_reports": {"ReportsCmdSet": type("ReportsCmdSet", (), {})},
        "evennia.contrib.game_systems.achievements.achievements": {"CmdAchieve": type("CmdAchieve", (), {})},
        "evennia.contrib.game_systems.barter": {"CmdsetTrade": type("CmdsetTrade", (), {})},
        "evennia.contrib.game_systems.clothing": {"ClothedCharacterCmdSet": type("ClothedCharacterCmdSet", (), {})},
        "evennia.contrib.game_systems.containers": {"ContainerCmdSet": type("ContainerCmdSet", (), {})},
        "evennia.contrib.game_systems.gendersub": {"SetGender": type("SetGender", (), {})},
        "evennia.contrib.game_systems.storage": {"StorageCmdSet": type("StorageCmdSet", (), {})},
        "evennia.contrib.rpg.rpsystem": {"RPSystemCmdSet": type("RPSystemCmdSet", (), {})},
...
class TestPlayerCommands(unittest.TestCase):
    ...
    def test_status_command_renders_core_panels(self):
        ...
        self.assertIn("Token：9", output)
        self.assertIn("力量：14", output)
        self.assertIn("攻擊：18", output)

    def test_inventory_command_marks_equipped_item_slot(self):
        """Inventory should annotate items that are currently equipped."""
